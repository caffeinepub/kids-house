...
function LearningSection({ onBack }) {
  const [tab, setTab] = reactExports.useState("alphabet");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "24px", maxWidth: "1200px", margin: "0 auto" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Learning Time! 📚", onBack }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: "12px", marginBottom: "24px" }, children: ["alphabet", "numbers"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        ...
        children: t === "alphabet" ? "🔤 A-Z Alphabet" : "🔢 1-10 Numbers"
      },
      t
    )) }),
    tab === "alphabet" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          display: "grid",
        ...
        children: ALPHABET_WORDS.map(([letter, word, emoji], i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "1.4rem" }, children: emoji }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
    ...
    tab === "numbers" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          display: "grid",
        ...
        children: NUMBER_WORDS.map(([num, word, emoji], i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "2rem" }, children: emoji }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
...
function MemoryGame() {
  const [deck, setDeck] = reactExports.useState(createMemoryDeck());
  ...
  const flipCard = reactExports.useCallback(
    (id) => {
      if (locked) return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: deck.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "memory-card-front", children: "?" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "memory-card-back", children: card.emoji })
                ]
              }
            )
          },
...
function GamesSection({ onBack }) {
  const [view, setView] = reactExports.useState("menu");
  if (view === "memory") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "24px", maxWidth: "800px", margin: "0 auto" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "24px", maxWidth: "1000px", margin: "0 auto" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Games 🎮", onBack }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
        ...
        children: games.map((g) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "3.5rem", marginBottom: "12px" }, children: g.emoji }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
...
function DrawingSection({ onBack }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "16px", maxWidth: "900px", margin: "0 auto" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Drawing Time! 🎨", onBack }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: "6px" }, children: DRAW_COLORS.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              style: {
                ...
                borderRadius: "50%",
                background: c,
                border: color === c && tool === "draw" ? "3px solid #1B2F66" : "2px solid rgba(0,0,0,0.15)",
                cursor: "pointer",
                transition: "transform 0.1s",
                boxShadow: color === c && tool === "draw" ? "0 0 0 3px rgba(27,47,102,0.3)" : "none",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "6px", flexWrap: "wrap" }, children: [
            sizes.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
...
function LongVideosSection({ onBack }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "24px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Long Videos 📺", onBack }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "long-videos-scroll",
        style: { display: "flex", gap: "20px", paddingBottom: "16px" },
        children: LONG_VIDEOS.map((v) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              minWidth: "320px",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
        ...
        children: "← Scroll to see more videos"
      }
    )
  ] });
}
function ShortVideosSection({ onBack }) {
  ...
  const goTo = (idx) => {
    ...
    if (container) {
      ...
      (_a2 = slides[next]) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        current < SHORT_VIDEOS.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: SHORT_VIDEOS.map((v, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            style: {
              background: "linear-gradient(135deg, #BFEFFF 0%, #7FD9FF 50%, #B5C6FF 100%)",
              padding: "48px 24px",
              textAlign: "center",
              position: "relative",
              overflow: "hidden"
            ...
            children: [
              ["⭐1", "🌟2", "✨3", "💫4", "⭐5", "🌟6", "✨7"].map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
                    position: "absolute",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", zIndex: 1 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    ...
                    children: "Welcome to Kids House! 🏠"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Learn, Play, Draw & Watch your favorite videos!"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    HOME_TILES.slice(0, 2).map((tile) => /* @__PURE__ */ jsxRuntimeExports.jsx(ActionTile, { tile, onNavigate }, tile.id)),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { gridColumn: "1 / -1" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ActionTile, { tile: HOME_TILES[2], onNavigate, wide: true }) }),
                    HOME_TILES.slice(3).map((tile) => /* @__PURE__ */ jsxRuntimeExports.jsx(ActionTile, { tile, onNavigate }, tile.id))
                  ]
                }
              )
            ]
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: wide ? 0 : "24px", flex: 1 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: wide ? "3.5rem" : "2.5rem", lineHeight: 1 }, children: tile.emoji }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                fontFamily: "'Fredoka One', cursive",
                fontSize: wide ? "clamp(1.5rem, 3vw, 2.2rem)" : "clamp(1.2rem, 2.5vw, 1.6rem)",
                color: tile.textColor,
                marginTop: "8px",
                lineHeight: 1
              },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                fontSize: "0.9rem",
                fontWeight: 700,
                color: tile.textColor === "white" ? "rgba(255,255,255,0.8)" : "rgba(27,47,102,0.65)",
                marginTop: "6px",
                fontFamily: "'Nunito', sans-serif"
              },
...
function App() {
  ...
  if (section === "shortvideos") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ShortVideosSection, { onBack: goHome });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { minHeight: "100vh", background: "#F7F8FC" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
      ...
      ` }),
    section === "home" && /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, { onNavigate: setSection }),
    section === "learning" && /* @__PURE__ */ jsxRuntimeExports.jsx(LearningSection, { onBack: goHome }),
    section === "games" && /* @__PURE__ */ jsxRuntimeExports.jsx(GamesSection, { onBack: goHome }),
    section === "drawing" && /* @__PURE__ */ jsxRuntimeExports.jsx(DrawingSection, { onBack: goHome }),
    section === "longvideos" && /* @__PURE__ */ jsxRuntimeExports.jsx(LongVideosSection, { onBack: goHome })
  ] });
}
...
const PinSettings = Record({
  "parentalPIN": Text,
  "userPIN": Text
});
const CreateUserInput = Record({
  "username": Text,
  "pinSettings": PinSettings,
  "password": Text,
  "email": Text
});
const AppLockState = Record({ "isLocked": Bool });
const AppLocks = Record({
  "tiktok": AppLockState,
...
Service({
  ...
  "createUser": Func([CreateUserInput], [ProfileView], []),
  "createVideoMeta": Func([CreateVideoMetaInput], [Text], []),
  "deleteVideoMeta": Func([Text], [Bool], []),
