...
export class Backend implements backendInterface {
    ...
    async createUser(arg0: CreateUserInput): Promise<ProfileView> {
        if (this.processError) {
            try {
    ...
    async createVideoMeta(arg0: CreateVideoMetaInput): Promise<string> {
        if (this.processError) {
            try {
    ...
    async deleteVideoMeta(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getAllVideos(): Promise<Array<VideoMeta>> {
        if (this.processError) {
            try {
    ...
    async isUserExists(arg0: Principal): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async saveAppLock(arg0: Principal, arg1: AppLocks): Promise<void> {
        if (this.processError) {
            try {
    ...
    async saveBasicSettings(arg0: Principal, arg1: UserSettings): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_ProfileView_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProfileView): ProfileView {
...
async function from_candid_VideoMeta_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _VideoMeta): Promise<VideoMeta> {
...
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_VideoMeta>): Promise<Array<VideoMeta>> {
    return await Promise.all(value.map(async (x)=>await from_candid_VideoMeta_n21(_uploadFile, _downloadFile, x)));
}
async function to_candid_CreateVideoMetaInput_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: CreateVideoMetaInput): Promise<_CreateVideoMetaInput> {
...
function to_candid_UserSettings_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UserSettings): _UserSettings {
